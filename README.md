...
I've also added a `chatbot.py` script in the `src` folder. See [`DEVELOPERS.md`](https://github.com/worldwidekatie/gpt-2/blob/master/DEVELOPERS.md) for instructions on using that and for fine tuning.
